...
def _safe_match_argument(expected_type, argument_value):
    ...
    if is_equal_type(GraphQLString, expected_type):
        return _safe_match_string(argument_value)
    elif is_equal_type(GraphQLID, expected_type):
        ...
        return _safe_match_string(argument_value)
    elif is_equal_type(GraphQLFloat, expected_type):
        return represent_float_as_str(argument_value)
    elif is_equal_type(GraphQLInt, expected_type):
    ...
    elif is_equal_type(GraphQLBoolean, expected_type):
        return type_check_and_str(bool, argument_value)
    elif is_equal_type(GraphQLDecimal, expected_type):
        return _safe_match_decimal(argument_value)
    elif is_equal_type(GraphQLDate, expected_type):
        return _safe_match_date_and_datetime(expected_type, (datetime.date,), argument_value)
    elif is_equal_type(GraphQLDateTime, expected_type):
